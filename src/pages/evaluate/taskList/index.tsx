...
import TaskRecordStatusEnum from '@/pages/evaluate/taskList/TaskRecordStatusEnum';
							...
							<div className=" landscape:w-[380px] portrait:w-[300px] p-5 bg-white rounded flex-center flex-col"
								...
								<div
									...
									<div className="flex flex-col ">
										<div className="text-left line-clamp-1 text-xl font-semibold">
											{templateName}
										</div>


										<div className="text-zinc-700 text-xs font-light font-['PingFang SC'] leading-[24px] tracking-wide">
									...
									<div className="flex items-end">
										...
										<Button type="primary" className="flex items-center justify-center px-[10px]"
														...
														/>}>  {
											taskRecordStatus === TaskRecordStatusEnum.IN_PROGRESS ? '评估中' : '开始评估'
										}</Button>
									</div>
								</div>
