...
import { Tooltip, Legend, Axis, Chart, Line, Point, ScrollBar, createRef } from '@antv/f2';
...
const TestTrend = () => {
	...
	const formatDate = (date) => {
		return `${dayjs(currentDate).format('YYYY')}-${dayjs(date).format('MM-DD')}`;
	};
